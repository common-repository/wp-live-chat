<?php
/*
Plugin Name: WP-Adult-Chat
Plugin URI: http://evbid.com/forums/wordpress-live-chat/livechat-readme-faq/page-1/post-5/#p5
Description: <strong>Live Chat</strong> adds a <em>Live Chat</em> button to your articles and pages which enable your visitors to directly connect to a Live IRC server. ADULT CONTENT:
Version: 0.2.2
Author: Bondage Radio
Author URI: http://bondageradio.com/
*/
...
echo 'if ((str1 == "Guest")||(str1 == "admin")) { str1 += "\?\?\?\?" };';
	echo 'document.getElementById(\'wpchatbox\').innerHTML = \'';
		...
		echo 'http://bondageradio.com/livechat0.2.0.5.php';
		echo '?t=1';
		echo '&c=\' + wpchat_title + \'';
		echo '&n=\' + str1 + \'';
		echo '&r=\' + document.URL + \'';
...
<span style=" width: 0; height: 0; display: block; visibility: hidden; overflow: hidden;">
	<a href="http://bondageradio.com/live-chat/">Bondage-Radio Live Chat Wordpress Plugin</a>
</span>
<p id="wpchatbox">
